...
if __name__ == "__main__":
    ...
    parser.add_argument("--folder", type=str, default="cache")
    parser.add_argument("--tarfile", type=str, default="cache.tar.gz")
    parser.add_argument("--drive_folder_id", type=str, default="1KTomPYcsQiBPrRj7bjHrvT78XBN3dbCC")
